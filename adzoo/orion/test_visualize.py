...
def parse_args():
    ...
    parser.add_argument('--vis-traj', action='store_true', help='visualize trajectory on images')
    parser.add_argument('--vis-save-dir', default='./trajectory_vis', help='directory to save visualization results')
    parser.add_argument('--vis-pred', action='store_true', default=True, help='visualize predicted trajectory (default: True)')
...
def main():
    ...
    if specific_data_path:
        ...
        filtered_infos = [
            ...
            if specific_data_path in info['sensors']['CAM_FRONT']['data_path']
        ]

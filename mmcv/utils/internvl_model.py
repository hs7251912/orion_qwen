...
from .internvl_arch import InternVLMetaModel, InternVLMetaForCausalLM


class InternVLConfig(LlamaConfig):
    model_type = "internvl"


class InternVLModel(InternVLMetaModel, LlamaModel):
    config_class = InternVLConfig

    def __init__(self, config: LlamaConfig):
        super(InternVLModel, self).__init__(config)


class InternVLForCausalLM(LlamaForCausalLM, InternVLMetaForCausalLM):
    config_class = InternVLConfig
...
AutoConfig.register("internvl", InternVLConfig)
AutoModelForCausalLM.register(InternVLConfig, InternVLForCausalLM)
